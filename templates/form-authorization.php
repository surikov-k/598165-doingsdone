...
<head>
  <meta charset="UTF-8">
  <title>Добавить задачу - Дела в порядке</title>
  ...
  <div class="container container--with-sidebar">
    ...
    <div class="content">
      ...
      <main class="content__main">
        ...
        <form class="form" action="form-authorization.php" method="post">
          <div class="form__row">
            <?php
            $error_class = isset($errors['email']) ? " form__input--error" : "";
            $input_value = isset($form['email']) ? $form['email'] : "";
            ?>
            <label class="form__label" for="email">E-mail <sup>*</sup></label>

            <input class="form__input <?= $error_class ?>" type="text" name="email" id="email" value="<?= $input_value ?>" placeholder="Введите e-mail">
          ...
          <div class="form__row">
            ...
            $input_value = isset($form['password']) ? $form['email'] : "";
            ?>
